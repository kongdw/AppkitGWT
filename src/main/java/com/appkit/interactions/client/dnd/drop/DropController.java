 ...
 * the License.
 */
package com.appkit.interactions.client.dnd.drop;

import com.appkit.interactions.client.dnd.DragContext;
import com.appkit.interactions.client.dnd.VetoDragException;
...
public interface DropController {
     ...
     * @see #onPreviewDrop(com.appkit.interactions.client.dnd.DragContext)
     */
     ...
     * by throwing a {@link com.appkit.interactions.client.dnd.VetoDragException}.
     *
     * @param context the current drag context
     * @throws com.appkit.interactions.client.dnd.VetoDragException if the proposed operation is unacceptable
     */
