 ...
 * the License.
 */
package com.appkit.interactions.client.dnd.util;

import com.appkit.interactions.client.dnd.util.impl.DOMUtilImpl;
...
public class DOMUtil {
    ...
    /**
     * Gets an element's test.client height in pixels or <code>0</code> (zero) when the element is hidden.
     * This is equal to offset height minus the top and bottom CSS borders.
     *
     * @param elem the element to be measured
     * @return the element's test.client height in pixels
     */
    ...
    /**
     * Gets an element's test.client widget in pixels or <code>0</code> (zero) when the element is hidden.
     * This is equal to offset width minus the left and right CSS borders.
     *
     * @param elem the element to be measured
     * @return the element's test.client width in pixels
     */
    ...
    /**
     * Set the browser's status bar text, if supported and enabled in the test.client browser.
     *
