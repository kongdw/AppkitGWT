...
public interface DragController extends FiresDragEvents {
    ...
    /**
     * Callback method for {@link test.client.interactions.MouseDragHandler}.
     */
    void dragEnd();
    ...
    /**
     * Callback method for {@link test.client.interactions.MouseDragHandler} when a drag operation is initiated for this drag
     * controller.
     */
    void dragStart();
     ...
     * {@link com.appkit.interactions.client.dnd.AbstractDragController#dragStart()}. This method should be called when a drop target's
