 ...
 * the License.
 */
package com.appkit.collection.shared;

import com.appkit.collection.client.JsLightArray;
import com.appkit.collection.client.JsLightArrayInteger;
import com.appkit.collection.client.JsLightMap;
import com.appkit.collection.shared.java.JavaLightArray;
import com.appkit.collection.shared.java.JavaLightArrayInt;
import com.appkit.collection.shared.java.JavaLightMap;
import com.google.gwt.core.client.GWT;

/**
 * A factory to create instances of the light collections api.
 * <p/>
 * If this is run in production code js objects are used to speed up collections. If run
